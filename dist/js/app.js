      ...
      (function(global, factory) {
        ...
        class Dropdown extends BaseComponent {
          ...
          static clearMenus(event2) {
            if (event2.button === RIGHT_MOUSE_BUTTON || event2.type === "keyup" && event2.key !== TAB_KEY) {
              return;
            }
            ...
            for (const toggle of openToggles) {
              ...
              if (context._menu.contains(event2.target) && (event2.type === "keyup" && event2.key === TAB_KEY || /input|select|option|textarea|form/i.test(event2.target.tagName))) {
                continue;
              }
              const relatedTarget = {
          ...
          static dataApiKeydownHandler(event2) {
            ...
            const isEscapeEvent = event2.key === ESCAPE_KEY;
            const isUpOrDownEvent = [ARROW_UP_KEY, ARROW_DOWN_KEY].includes(event2.key);
            ...
            event2.preventDefault();
            const getToggleButton = this.matches(SELECTOR_DATA_TOGGLE) ? this : SelectorEngine.prev(this, SELECTOR_DATA_TOGGLE)[0] || SelectorEngine.next(this, SELECTOR_DATA_TOGGLE)[0] || SelectorEngine.findOne(SELECTOR_DATA_TOGGLE, event2.delegateTarget.parentNode);
